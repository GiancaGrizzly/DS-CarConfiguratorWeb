...
class TapiceriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tapicerium" do
    assert_difference("Tapicerium.count") do
      post tapiceria_url, params: { tapicerium: { nombre: @tapicerium.nombre, pathImagen: @tapicerium.pathImagen, precio: @tapicerium.precio } }
    end
  ...
  test "should update tapicerium" do
    patch tapicerium_url(@tapicerium), params: { tapicerium: { nombre: @tapicerium.nombre, pathImagen: @tapicerium.pathImagen, precio: @tapicerium.precio } }
