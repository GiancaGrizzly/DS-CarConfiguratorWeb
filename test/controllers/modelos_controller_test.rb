...
class ModelosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modelo" do
    assert_difference("Modelo.count") do
      post modelos_url, params: { modelo: { nombre: @modelo.nombre, pathImagen: @modelo.pathImagen, precio: @modelo.precio } }
    end
  ...
  test "should update modelo" do
    patch modelo_url(@modelo), params: { modelo: { nombre: @modelo.nombre, pathImagen: @modelo.pathImagen, precio: @modelo.precio } }
