...
class ColorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create color" do
    assert_difference("Color.count") do
      post colors_url, params: { color: { nombre: @color.nombre, pathImagen: @color.pathImagen, precio: @color.precio } }
    end
  ...
  test "should update color" do
    patch color_url(@color), params: { color: { nombre: @color.nombre, pathImagen: @color.pathImagen, precio: @color.precio } }
